...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="{{ route('customers.groups.add') }}">add</a></li>
</ol>
<!-- END BREADCRUMB --> 
<form action="{{ route('customers.groups.store') }}" method="post" class="sodirty" autocomplete="off">
{{ csrf_field() }}
  <div  class="card card-transparent">
    <div class="card-header ">
        <div>
            <h1 class="section-title">Create a Customer Group</h1>
        </div>
    </div>
                      ...
                      <div id="card-advance" class="card card-default">
                        <div class="card-block">
                            ...
                            <div class="form-group{{ $errors->has('group_name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" id="group_name" class="form-control{{ $errors->has('group_name') ? ' form-control-danger' : '' }}" name="group_name" value="{{ old('group_name') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('group_discount') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" id="group_discount" class="form-control autonumeric{{ $errors->has('group_discount') ? ' form-control-danger' : '' }}" name="group_discount" value="{{ old('group_discount') }}">
                                </div>
