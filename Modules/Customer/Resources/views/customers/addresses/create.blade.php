...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="{{ route('customers.addresses.add') }}">add</a></li>
</ol>
<!-- END BREADCRUMB --> 
<div  class="card card-transparent">
  <div class="card-header ">
      <div>
          <h1 class="section-title">Add Customer Address</h1>
      </div>
  </div>
                  ...
                  <div class="card-block no-padding">
                    <div id="card-advance" class="card card-default">
                      <div class="card-block">
                        <form id="shippingClassForm" action="{{ route('customers.addresses.store') }}" method="post">
                        {{ csrf_field() }}
                          ...
                          <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                              ...
                              <input type="text" id="fistname" class="form-control{{ $errors->has('firstname') ? ' form-control-danger' : '' }}" name="firstname" value="{{ old('firstname') }}" required>
                          ...
                          <div class="form-group{{ $errors->has('company') ? ' has-danger' : '' }}">
                              ...
                              <input type="text" id="company" class="form-control{{ $errors->has('company') ? ' form-control-danger' : '' }}" name="company" value="{{ old('company') }}">
                          ...
                          <div class="form-group{{ $errors->has('address1') ? ' has-danger' : '' }}">
                            <label for="address1">Address 1 </label>
                              <input id="address1" type="text" class="form-control{{ $errors->has('address1') ? ' is-invalid' : '' }}" name="address1" required value="{{ old('address1') }}">
                          ...
                          <div class="form-group{{ $errors->has('country') ? ' has-danger' : '' }}">
                              ...
                              <select name="country" id="country" class="form-control{{ $errors->has('country') ? ' form-control-danger' : '' }}" data-init-plugin="select2" required>
                          ...
                          <div class="form-group {{ $errors->has('postcode') ? ' has-danger' : '' }}">
                              ...
                              <input id="postcode" type="text" class="form-control" name="postcode" required value="{{ old('postcode') }}">
