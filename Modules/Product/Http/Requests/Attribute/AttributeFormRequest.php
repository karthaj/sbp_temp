...
class AttributeFormRequest extends FormRequest
{
    ...
    {
        return [
            'option_name' => 'required|max:255|unique_to_store:attributes,name',
            ...
            'swatches.*.image' => 'required_if:swatches.*.type,pattern',
    ...
    public function messages()
    {
        return [
            ...
            'swatches.*.image.required_if' => 'Pattern is required'
        ];
    }
}
