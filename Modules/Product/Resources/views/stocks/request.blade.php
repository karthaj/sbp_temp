  ...
  <div class="col-lg-12">
    <div class="card card-transparent">
      <div class="card-header">
        <h1 class="section-title">Request Stocks</h1>
      </div>
      <request-stock searchendpoint="{{ route('transfer.product.search') }}" endpoint="{{ route('transfer.product.get') }}" :stores="{{ $stores }}" transfer-endpoint="{{ route('stock.request') }}"></request-stock>
    </div>
  </div>
</div>
