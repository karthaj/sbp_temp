...
<div  class="card card-transparent">
  <div class="card-header ">
     <h1 class="section-title">Edit Option</h1>
  </div>
  ...
  <div class="m-0 row card-block">
      ...
      <div class="col-lg-8 sm-no-padding">
        <manage-attribute endpoint="{{ route('attributes.update', $attribute['data']['id']) }}" cancel-endpoint="{{ route('attributes.index') }}" redirect-to="{{ route('attributes.index') }}" :attribute="{{ json_encode($attribute['data']) }}" :edit-mode="true"></manage-attribute>
      </div>
  </div>
</div>
