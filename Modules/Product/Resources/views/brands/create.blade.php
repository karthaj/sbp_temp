...
<div  class="card card-transparent">
  <div class="card-header ">
      <div>
          <h1 class="section-title">Add a Brand</h1>
      </div>
  </div>
  <div class="m-0 row card-block">
      ...
      <div class="col-lg-8 sm-no-padding">
        <form id="featureForm" action="{{ route('brands.store') }}" method="post" autocomplete="off" enctype="multipart/form-data" class="sodirty">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12">
               <div class="card card-transparent">
                      ...
                      <div class="card-block">
                          <div class="row">
                              <div class="col-sm-12 form-group">
                                  <label>Name</label>
                                  <input type="text" id="name" class="form-control{{ $errors->has('name') ? ' error' : '' }}" required name="name">
                                  @if($errors->has('name'))
        ...
        <div class="row">
                      ...
                      <div class="card-block">
                        <div class="row">
                            <div class="col px-0 form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('page_title') ? ' error' : '' }}" id="page_title" name="page_title">
                        ...
                        <div class="row">
                            <div class="col px-0 form-group">
                                ...
                                <textarea name="meta_description" id="meta_description" cols="30" rows="5" class="form-control{{ $errors->has('meta_description') ? ' error' : '' }}"></textarea> 
                        ...
                        <div class="row">
                            <div class="col px-0 form-group">
                                ...
                                <span class="text-muted pull-right">Max 160 characters</span>
                                <input class="tagsinput form-control{{ $errors->has('meta_keywords') ? ' error' : '' }}" data-role="tagsinput" type="text" id="meta_keywords" name="meta_keywords">
                        ...
                        <div class="row">
                            <div class="col px-0 form-group"> 
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="url_handle" name="url_handle" class="form-control{{ $errors->has('url_handle') ? ' error' : '' }}">
                                </div>
                            </div>
                        </div>
                      </div>
          ...
          @include ('zpanel.partials._form_actions', ['path' => route('brands.index')])
        </form>
      </div>
  </div>
</div>
