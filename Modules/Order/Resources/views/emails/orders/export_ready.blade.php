...
<p style="font-size: 14px; line-height: 26px; margin: 0;"><span style="font-size: 22px;">Dear <strong>{{ $store->store_name }}</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;">Your Orders export has been generated and is ready to download.</span></p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"> </p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;"><a href="{{ $url }}">Download my Orders file</a></span></p>
</div>
<p style="font-size: 14px; line-height: 21px; color: #333333;"><strong>Note:</strong> Orders file will be deleted from the server once downloaded.</p>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 10px; line-height: 19px; margin: 0;">If you’re having trouble clicking the "Download my Orders file" link, copy and paste the URL below
