<template>
	...
	<div v-if="checkout.cart" class="col-lg-5 col-md-5 col-ms-12 d-none d-lg-block d-xl-block">
        ...
        <div class="card card-default">
            ...
            <div class="col-md-12 py-4 line" v-if="checkout.cart.total_discount == 0">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <input type="text" class="form-control input-sm" placeholder="COUPON CODE HERE"
  ...
  methods: {
    ...
    applyDiscountCode () {
      ...
      axios.post(`/checkout/${this.checkout_id}/discounts`, {
        ...
        if(error.response.data.discount_code) {
          this.error = error.response.data.discount_code[0];
        }
