        ...
        <div class="col">
          <div data-pages="card" class="card card-default">
            <div class="card-header separator">
              <div class="row">
                <div class="col-md-3">
                  <a :href="transferurl" class="btn btn-action-add btn-xs">{{ label }}</a>
                </div>
                <div class="col-md-4">
                  <div class="form-group row align-items-center">
                    <label class="control-label col-md-4">select store</label>
                    <select class="pull-right form-control col-md-8"  v-model="store" @change="getRecords">
            ...
            <div  class="card-block pt-20">
                <div class="table-responsive" v-if="filteredRecords.length">
                    ...
                    <pagination :pagination="meta.pagination" for="transfers" class="mt-4"></pagination>
                </div>
...
<script>
    ...
    export default {
        props: ['endpoint', 'transferurl', 'stores', 'label'],
        components: {
          Pagination,
          transferDetail,
          updateTransfer
        ...
        mounted() {
            ...
            eventHub.$on('transfers.switched-page', this.getRecords)
