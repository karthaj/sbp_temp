<template>
  <div class="card-block">
                          ...
                          <div class="row justify-content-center">
                            <div class="col-md-5">
                              <div class="form-group row">
                                <label for="from" class="col-md-3 col-form-label">Type</label>
                                <div class="col-md-9">
                                  <select id="from" class="form-control" v-model="transfer_type">
                                    <option value="consignment">Consignment</option>
                                    <option value="sa">Stock Assurance</option>
                                  </select>
                                </div>
                            ...
                            <div class="col-md-5">
                              <div class="form-group row">
                                <label for="store" class="col-md-3 col-form-label">To Store</label>
                                <div class="col-md-9">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <input type="text" id="search" class="form-control input-lg typeahead sample-typehead" placeholder="Search" autocomplete="off"> 
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row align-items-end">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <input type="text" id="price" class="form-control" v-model="product.price" disabled>
                              </div>
                            </div>
                            <div class="col-md-1">
                              <div class="form-group">
                            ...
                            <div class="col-md-1">
                              <div class="form-group">
                                <label for="discount">dis %</label>
                                <input type="text" id="discount" class="form-control" v-model="product.discount" v-on:keypress="isNumber($event)">
                              </div>
                            </div>
                            <div class="col-0">
                              <div class="form-group">
                                <label for="total">total</label>
                                <input type="text" id="total" class="form-control" v-model="total" disabled>
                              </div>
                            </div>
                            <div class="col-md-2">
                              <div class="form-group">
    ...
    <div class="form-group">
      <button class="btn btn-action-save" type="button" :disabled="stocks.length === 0"
...
<script>
    ...
    export default {
        props: ['stores', 'searchendpoint', 'endpoint', 'transfer-endpoint', 'label'],
        data () {
            return {
              stocks: [],
              transfer_store: '',
              transfer_type: 'consignment',
              remarks: '',
              product: {
                stock_id: '',
                sku: '',
        ...
        computed: {
            total () {
              var total = this.product.qty * this.product.price;
             
              if(this.product.discount > 0) {
                total -= total * this.product.discount / 100;
              }
              
              this.product.total = total.toFixed(2);
        ...
        methods: {
          ...
          add(product) {
            ...
            this.stocks.reverse();
            //this.product.stock_id =  this.product.sku = this.product.price = this.product.stock = '';
