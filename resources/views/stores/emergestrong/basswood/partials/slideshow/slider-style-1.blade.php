                    ...
                    <div class="container">
                        <div class="hero-slider-content">
                            ...
                            @if($section['blocks'][$block]['settings']['button_label'])
                                <a class="shop-btn" href="{{ $section['blocks'][$block]['settings']['button_link'] }}" style="background: {{  $section['settings']['button_bg_color'] }}; color: {{  $section['settings']['text_color'] }};">{{ $section['blocks'][$block]['settings']['button_label'] }}</a>
                            @endif
                            </div>
                        </div>
                    </div>
