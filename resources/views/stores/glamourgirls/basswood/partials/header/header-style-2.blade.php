<header id="header_style_2">
    <div class="header-container">
        <div class="header-bottom-area header-transparent header-sticky" class="{{ !$settings['box_view'] ? 'header-3' : '' }} {{ $settings['sections'][$settings['content_for_index'][0]]['type'] === 'slideshow' ? 'header-absolute' : ''}}">
