          ...
          <div class="row">
             <div class="col-12">
                 <div class="logo-3 d-none">
                    @if($section['settings']['logo'])
                      <a href="{{ getStoreUrl($store) }}"><img src="{{ asset('stores/'.$store->domain.'/img/'.$section['settings']['logo']) }}" alt="{{ $store->store_name }}" style="max-height: {{ $section['settings']['logo_max_height'] }}px"></a>
                    @else
                      <a href="{{ getStoreUrl($store) }}"><img src="https://via.placeholder.com/123x36.png?text=Logo" alt="{{ $store->store_name }}" style="max-height: {{ $section['settings']['logo_max_height'] }}px"></a>
                    @endif
                 </div>
             </div>
              <div class="col-12">
