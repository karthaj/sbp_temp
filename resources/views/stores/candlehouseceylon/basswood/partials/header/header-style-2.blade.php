<header id="header_style_2">
    <div class="header-container">
        <div class="header-bottom-area header-transparent header-sticky {{ !$settings['box_view'] ? 'header-3' : '' }} {{ request()->path() == '/' && $settings['sections'][$settings['content_for_index'][0]]['type'] === 'slideshow' ? 'header-absolute' : ''}}">
