...
<head>
	...
	<meta property="og:type" content="website" />
  	...
  	<meta property="og:description" content="{{ $store->setting->meta_description ?: $store->store_name.' store powered by ShopBox. Create your store today FOR FREE.' }}" />
  	...
  	<meta property="twitter:description" content="{{ $store->setting->meta_description ?: $store->store_name.' store powered by ShopBox. Create your store today FOR FREE.' }}" />
  	@if($store->setting->logo)
