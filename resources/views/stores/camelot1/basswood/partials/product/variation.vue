...
<form action="#">
    <div class="product-variants mb-2">
        <div v-for="option, index in productOptions" :key="option.id" class="product-variants-item">
					...
					<div class="form-field-title">{{ option.name }}:</div>
				  	<div class="form-field-control">
				      	<label v-for="value in option.values" :key="value.id" class="swatch-wrap">
					        ...
					        <span class="swatch">
					            <span v-if="value.pattern" class="swatch-color" :class="{'disabled-control': value['disabled'] }" :style="`{'background-image': url(${value.pattern})}`"></span>
