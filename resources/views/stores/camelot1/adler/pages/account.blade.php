...
<link rel="stylesheet" href="{{ asset('stores/'.$store->domain.'/themes/adler/assets/account.css') }}">

@endsection

@section('content')

	<div id="my-account" class="container-fluid mt-5">
    <div class="row my-2">
                    ...
                    <div class="profile-card mb-1">
                        ...
                        <div class="profile-upload">
                            <label class="custom-file">
                                ...
                                <span class="custom-file-control"><i class="aapl-camera2"></i></span>
                            </label>
                        </div>
                    </div>   
                </div>
