@if($section['disabled'] === false)
    <div id="shopbox-section-{{ $section_id }}" class="feature-section feature-section-3  mb-85">
        <div class="container">
            <div class="feature-container gray-bg pt-35 pb-5">
              <div class="row">
                <div class="col-md-4 col-12 mb-30">
                    <div class="basswood-single-feature single-feature-3">
