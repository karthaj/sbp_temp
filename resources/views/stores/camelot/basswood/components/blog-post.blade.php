                                                ...
                                                <div class="single-blog blog-style-2 mb-30">
                                                    <div class="blog-info">
                                                        <div class="blog-date-time">
                                                            <span class="blog-month">{{ $post['created']->format('F') }}</span>
                                                            <span class="blog-date">{{ $post['created']->format('d') }}</span>
                                                        </div>
                                                        <div class="single-blog-content">
                                                            ...
                                                            <div class="blog-meta">
                                                                <ul>
                                                                    <li><i class="fa fa-calendar"></i>{{ $post['created']->toFormattedDateString() }}</li>
                                                                    <li>-</li>
                                                                    <li><i class="fa fa-user"></i>{{ $post['author'] }}</li>
                                                                </ul>
                                                            </div>
                                                            <p class="blog-description">{{ str_limit(strip_tags($post['content']), 145) }}</p>
