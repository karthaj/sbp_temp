...
@if(request()->tab === 'return')
	@if($errors->has('return_qty.*'))
		<div class="alert alert-info" role="alert">
		    <i class="ti-info-alt mr-2" aria-hidden="true"></i> Please select one or more items to return.
	...
	@if(session()->has('info'))
		<div class="alert alert-info" role="alert">
		    <i class="ti-info-alt mr-2" aria-hidden="true"></i> {{ session('info') }}
		    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		    	<span aria-hidden="true">&times;</span>
		  	</button>
		</div>
	   	...
	   	<form action="{{ route('customer.order.return', $order) }}" method="post">
		    ...
		    <div class="form-group">
	      	...
	      	<div class="form-group col-sm-3 mt-5 mx-auto">
		    	<button type="submit" class="btn_1 btn-block">Submit</button>
		    </div>
