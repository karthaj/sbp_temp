     ...
     <form action="{{ route('stores.contact', $page) }}" method="post" autocomplete="off">
        {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <div class="col-xl-12 col-lg-12 col-mb-12 col-sm-12 col-xs-12">
                <div id="g-recaptcha" class="form-group" data-sitekey="{{ $store->setting->captcha_site_key ?: config('services.recaptcha.site_key') }}" data-size="invisible" data-action="{{ $store->domain }}_contactpage" data-badge="inline"></div>
              </div>
              <div class="col-xl-12 col-lg-12 col-mb-12 col-sm-12 col-xs-12">
