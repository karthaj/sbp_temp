...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="{{ asset('assets/img/sb-white-text.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 203px; display: block;" title="Image" width="203"/>
...
<p style="font-size: 14px; line-height: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{ $user->first_name }}</strong>, registration completed</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;">Staff access account created. Verify your account by clicking "Activate My Account" button at the bottom of this message.</span></p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"> </p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;">Please ensure to use your account as per the instructions of the Store Owner.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<div align="center" class="img-container center fixedwidth" style="padding-right: 0px;padding-left: 0px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="{{ asset('assets/img/emails/illo.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 530px; display: block;" title="Image" width="530"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-size: 16px; color: #333333;">This account is created by {{ $store->store_name }} administrator</span></p>
<p style="font-size: 14px; line-height: 19px; margin: 0;"><br/><span style="font-size: 16px;"><span style="color: #333333; font-size: 16px; line-height: 19px;">Your username is:</span> <span style="color: #ffbf00; font-size: 16px; line-height: 19px;"><strong>{{ $user->email }} <br/></strong></span></span></p>
<p style="font-size: 14px; line-height: 19px; margin: 0;"> <span style="font-size: 16px; color: #333333;"><span style="font-size: 16px; line-height: 19px;"></span></span></p>
<p style="font-size: 14px; line-height: 16px; margin: 0;"> </p>
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-size: 16px; color: #333333;"><span style="font-size: 16px; line-height: 19px;"><span style="font-size: 16px; line-height: 19px;">By using your login you have agreed to abide by all the rules, Terms and Conditions, Privacy Policies, Agreements and Ethical guidelines as set out by ShopBox.</span></span></span><span style="font-size: 16px; line-height: 19px; color: #333333;"><span style="font-size: 16px; line-height: 19px;"></span></span></p><br />
<p style="font-size: 12px; line-height: 19px; margin: 0;"><span style="font-size: 10px; color: #333333;"><span style="font-size: 10px; line-height: 19px;"><span style="font-size: 16px; line-height: 19px;">If you’re having trouble clicking the "ACTIVE MY ACCOUNT" link, copy and paste the URL below
into your web browser:</span></span></span></p>
<a href="{{ $url }}">{{ $url }}</a>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="background-image:url({{ asset('assets/img/emails/password_key_bg.gif') }});background-position:top center;background-repeat:no-repeat;background-color:transparent;">
...
<div style="font-size: 12px; line-height: 14px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #555555;">
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-size: 16px;">To <span style="color: #132f40; line-height: 19px; font-size: 16px;"><strong>activate your account  </strong></span></span><span style="font-size: 16px; line-height: 19px;">you just need to set your password.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<a href="{{ $url }}">
<div align="left" class="button-container" style="padding-top:5px;padding-right:10px;padding-bottom:35px;padding-left:10px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 5px; padding-right: 10px; padding-bottom: 35px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31.5pt; width:165pt; v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#0B5FDE"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#FFFFFF; font-family:Arial, sans-serif; font-size:15px"><![endif]-->
<div style="text-decoration:none;display:inline-block;color:#FFFFFF;background-color:#0B5FDE;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px;width:auto; width:auto;;border-top:1px solid #0B5FDE;border-right:1px solid #0B5FDE;border-bottom:1px solid #0B5FDE;border-left:1px solid #0B5FDE;padding-top:5px;padding-bottom:5px;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:15px;display:inline-block;">
...
<div style="background-color:transparent;">
<div class="block-grid mixed-two-up" style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #000000;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:#000000;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#000000"><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="400" style="background-color:#000000;width:400px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->
...
<!--<![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 20px; padding-top: 20px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
<div style="color:#F8F8F8;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:200%;padding-top:20px;padding-right:10px;padding-bottom:10px;padding-left:20px;">
<div style="font-size: 12px; line-height: 24px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #F8F8F8;">
<p style="font-size: 14px; line-height: 28px; margin: 0;">Shopbox - Build your eCommerce presence.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<!--[if (mso)|(IE)]></td></tr></table><![endif]-->
<!--[if (mso)|(IE)]></td><td align="center" width="200" style="background-color:#000000;width:200px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.facebook.com/shopbox.lk" target="_blank"><img alt="Facebook" height="32" src="{{ asset('assets/img/emails/facebook@blue2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://twitter.com/ShopBoxlk" target="_blank"><img alt="Twitter" height="32" src="{{ asset('assets/img/emails/twitter@blue2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="http://instagram.com/shopboxlk" target="_blank"><img alt="Instagram" height="32" src="{{ asset('assets/img/emails/instagram@blue2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Instagram" width="32"/></a></td>
</tr>
</tbody>
</table>
</td>
