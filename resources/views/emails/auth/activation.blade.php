...
<p style="font-size: 14px; line-height: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{ $user->first_name }}</strong>,</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;">Thank you for registering with ShopBox. We aim to support aspiring businesses like yours from
around the country with our innovative e-commerce platform. This is going to be a great journey!</span></p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"> </p>
<p style="font-size: 14px; line-height: 21px; margin: 0;"><span style="color: #333333; font-size: 14px; line-height: 21px;">There’s just one more thing we need you to do before you can start building your own online store. Please verify your e-mail address by clicking on the following link:</span></p>
</div>
</div>
<div style="background-image:url({{ asset('assets/img/emails/password_key_bg.gif') }});background-position:bottom center;background-repeat:no-repeat;background-color:transparent;">
...
<!--[if mso]></td></tr></table><![endif]-->
<a href="{{ route('activation.activate', $token) }}">
...
<div style="font-size: 12px; line-height: 14px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #555555;">
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-size: 16px; color: #333333;">Once you’ve verified your email address you can access your ShopBox merchant account to update your details and start putting together your store.</span></p>
<br />
...
<br />
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-size: 16px; color: #333333;"><span style="font-size: 16px; line-height: 19px;"><span style="font-size: 16px; line-height: 19px;">If you have any questions, feel free to contact our support team on support@shopbox.lk or call +94 753 111 222 and we’ll be glad to help you out.</span></span></span><span style="font-size: 16px; line-height: 19px; color: #333333;"><span style="font-size: 16px; line-height: 19px;"></span></span></p>
<p style="font-size: 12px; line-height: 19px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;"><span style="font-size: 16px;"></span><br/><span style="font-size: 16px; line-height: 19px;">Regards,</span><br/><strong><span style="font-size: 16px; line-height: 19px;">ShopBox Account Team</span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
