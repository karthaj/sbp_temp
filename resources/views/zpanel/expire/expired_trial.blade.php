        ...
        <div  class="page-content-wrapper">
                ...
                <div id="app" class="container-fluid container-fixed-lg">
					...
					<div class="row py-3 px-3 text-center cDiv">
						...
						<div class="col-md-12">
							<h5>Thank you for trying out ShopBox.</h5>
							<p>Your free trial has come to an end, and your account has been temporarily suspended.</p><hr>
							<img class="img-fluid" src="{{ asset('assets/img/trial_expired.png') }}" width="400"><hr>
							<p>Don't worry, your store data has not been lost. <br>
								You will be able to re-activate your account by selecting a plan within one month of your trial ending.</p>
							<p>If no plan has been selected after one month has lapsed, your account will be deactivated permanently and all your data cannot be recovered.</p><br>
							<a class="btn btn-action-add" href="{{ route('plan.index') }}">Choose Plan</a>
