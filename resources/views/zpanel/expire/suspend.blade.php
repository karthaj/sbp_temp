                ...
                <div id="app" class="container-fluid container-fixed-lg">
					...
					<div class="row py-3 px-3 text-center cDiv">
						...
						<div class="col-md-12">
							...
							<p>Your account has been temporarily suspended; you would have received an email with more details regarding your suspension.</p><hr>
							<img class="img-fluid" src="{{ asset('assets/img/account_suspend.png') }}" width="400"><hr>
							
							<p>Please contact ShopBox support to address the reasons for the suspension to determine whether a solution can be reached.</p>
