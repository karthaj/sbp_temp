  ...
  <body>
    <table>
      <tbody>
        <tr>
          <td>
            <a href="{{ route('dashboard') }}" class="btn btn-info btn-xs">Dashboard</a>
          </td>
          <td>
            <a href="{{ route('invoice.download', $billing) }}" class="btn btn-info btn-xs">Download</a>
          </td>
          @if($billing->state === 0)
            <td>
              <a href="{{ route('store.checkout.index', $billing) }}" class="btn btn-info btn-xs">Pay</a>
            </td>
          @endif
        </tr>
      </tbody>
