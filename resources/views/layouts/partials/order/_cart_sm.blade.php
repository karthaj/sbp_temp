<div id="orderSummary" class="card card-default d-lg-none collapse">
        ...
        <tbody class="total-line-table__tbody">
          <tr class="total-line total-line--subtotal">
            ...
            <td class="total-line__price">
              <span class="order-summary__emphasis">{{ $currency }} {{ number_format($order->total_products, 2) }}</span>
            </td>
          </tr>
        ...
        <tfoot class="total-line-table__footer">
          <tr class="total-line">
            ...
            <td class="total-line__price payment-due">
              <span class="payment-due__price">{{ $currency }} {{ number_format($order->total_paid, 2) }}</span>
            </td>
          </tr>
        </tfoot>
    </table>
